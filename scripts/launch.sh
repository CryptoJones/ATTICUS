#!/bin/bash
# ATTICUS — infrastructure-agnostic training launcher
#
...
#   bash <(curl -s https://codeberg.org/Ronin48/ATTICUS/raw/branch/main/scripts/launch.sh)

set -e

REPO_URL="https://codeberg.org/Ronin48/ATTICUS.git"
REPO_NAME="ATTICUS"
